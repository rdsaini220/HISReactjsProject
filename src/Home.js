				...
				<Row className="clearfix">
					<div className="content-column col-lg-6 col-md-12 col-sm-12">
						<div className="inner-column">
                            ...
                            <WebButton className="lightbox-image theme-btn btn-style-one btnprimary mt-4" link={'/Home'} name={'Make Appointment'}  icon={<i className="flaticon-phone-call pr-2"></i>} />
